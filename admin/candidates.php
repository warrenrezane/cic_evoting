...
<body>
  ...
  <div class="container-fluid mt-2" style="padding:40px; padding-top:10px;"> 
    <div class="row">
      <div class=" col-sm-12 col-md-9 col-lg-9 col-xl-9">
        <h1 class=" text-sm-center text-xs-center text-md-left text-lg-left text-xl-left">Candidates</h1>
      </div>
      <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
        <button class="btn btn-info btn-block" data-toggle="modal" data-target="#addUpdate" style="margin-left:55%;">Add Candidate</button>
      </div>
    </div>
    <table class="table text-center" id="can_tbl">
      <thead>
        <tr>
            <th>Image</th>
            <th>Student ID</th>
