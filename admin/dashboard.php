...
<body>
    <div id="printTarget">
        <center>
            <h2><span id='printTitle'>Winners</span> (<span id="dateHolder"></span>)</h2>
        </center>
        <table class="table">
            <thead>
                <tr id="printTr">
            ...
            <div class="d-flex flex-row">
                <h1 class="flex-grow-1 ml-2">Live Result</h2>
                    <div>
                        ...
                        <button class="btn btn-primary" id="print_winner_button" onclick="print_winner('winner')">Print Winners <i class='fa fa-print'></i></button>
                    </div>
            </div>
...
<script>
    ...
    function displayz(date_today) {
        ...
        $.ajax({
            ...
            data: {
                count: '---',
                election_date: election_date.value
            },
            success: (e) => {
                ...
                for (pos of position) {
                    ...
                    for (el of data.position_count) {
                        ...
                        if (!checkPosition) {
                            candidateByPos.push({
                                ...el,
                                candidates: position.find(poz => poz.positionname == el.positionname).candidates
                            });
                        }
                    }
                    ...
                    for (can of pos.candidates) {
                        ...
                        percentage_.push({
                            canidateIdElement: `p${can.candidateid}`,
                            percent: percent
                        });
                    }
