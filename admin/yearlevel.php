  ...
  <div class="container-fluid mt-2"> 
    <div class="row">
      ...
      <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
        <button class="btn btn-info btn-block" data-toggle="modal" data-target="#addUpdate"  style="margin-left:55%;">Add Year Level</button>
      </div>
    </div>
    <table class="table text-center" id="yrlvl_tbl">
      <thead>
        <tr> 
