  ...
  <div class="container-fluid mt-2"> 
    <div class="row">
      <div class=" col-sm-12 col-md-9 col-lg-9 col-xl-9">
        <h1 class=" text-sm-center text-xs-center text-md-left text-lg-left text-xl-left">Party</h1>
      </div>
      <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
        <button class="btn btn-info btn-block" data-toggle="modal" data-target="#addUpdate" style="margin-left:55%;">Add Party</button>
      </div>
    </div>
    <table class="table text-center" id="party_tbl">
      <thead>
        <tr> 
          <th>Party Initial</th>
          <th>Party Name</th>
