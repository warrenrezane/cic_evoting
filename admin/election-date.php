...
<body>
  ...
  <div class="container-fluid mt-2"> 
    <div class="row">
      ...
      <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2">
        <button class="btn btn-info btn-block"  onclick="electionIdForm.reset();" id="add" data-toggle="modal" data-target="#addUpdate">Set Election Date</button>
      </div>
    </div> 
    <table class="table text-center" id="election_tbl">
      <thead>
        <tr>  
